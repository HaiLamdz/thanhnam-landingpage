...
<div class="d-flex align-items-center justify-content-between mb-4">
    <h4 class="mb-0">Sửa dự án: {{ $project->title }}</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" rows="3" class="form-control @error('description') is-invalid @enderror"
                            placeholder="Tóm tắt ngắn gọn về dự án...">{{ old('description', $project->description) }}</textarea>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <x-admin.image-preview :path="$project->image_path" />
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                            <option value="draft" {{ old('status', $project->status) === 'draft' ? 'selected' : '' }}>Nháp</option>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="client" class="form-control @error('client') is-invalid @enderror"
                            value="{{ old('client', $project->client) }}" placeholder="Tên khách hàng...">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="location" class="form-control @error('location') is-invalid @enderror"
                            value="{{ old('location', $project->location) }}" placeholder="Hà Nội, Việt Nam...">
                    ...
                    <div class="mb-0">
                        ...
                        <input type="text" name="completion_status" class="form-control @error('completion_status') is-invalid @enderror"
                            value="{{ old('completion_status', $project->completion_status ?? 'Hoàn thành') }}"
                            placeholder="Hoàn thành / Đang thi công...">
